...
import AdvancesWeb from '../assets/Front-EndWebDesigning.png'
    ...
    return (
        <div data-aos="fade-up" className='bg-bg-color shadow-[inset_0_30px_35px_0px_rgba(0,0,0,0.2)]  p-10 tablet-or-mobile:p-2'>
            <div className='tablet-or-mobile:mt-7 mb-10'>
                ...
                <div className='grid mt-6 w-full grid-cols-2 gap-y-12 tablet-or-mobile:gap-y-3 tablet-or-mobile:grid-cols-2'>
                    ...
                    <div className='col-span-1 flex justify-center'>
                        <CertificateCard image={AdvancesWeb} />
                    </div>
                </div>
